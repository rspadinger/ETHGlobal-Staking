...
interface WithdrawCardProps {
    ...
    account?: string | null // Optional connected account
}
...
export function WithdrawCard({
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [name, symbol] = await Promise.all([getTokenName(), getTokenSymbol()])
                        ...
                        <p className="text-sm flex items-center">
                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    ...
                                    <TooltipContent>
                                        <p>
                                            Staking for at least {stakingDuration} days avoids the early withdrawal
                                            penalty
                                        </p>
                                    </TooltipContent>
                                </Tooltip>
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Withdrawing before {stakingDuration} days will incur a {earlyWithdrawalPenalty}%
                                        penalty. You will receive {withdrawalAmount.toFixed(2)} {tokenSymbol} instead of{" "}
